...
def run_sequential(args, logger):
    ...
    scheme = {
        ...
        # Instant incentive
        "attention_latent": {"vshape": (args.max_vehicle_num, args.bottleneck_dim,), "group": "agents"},
        "att_encoder_hidden": {"vshape": (args.max_vehicle_num, 2 * args.attention_dim,), "group": "agents"},
