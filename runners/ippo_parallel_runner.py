...
class ParallelRunner:
    ...
    def get_env_info(self, args):
        obs_shape = args.obs_shape_single * args.n_obs_vehicles  # 5 * 15
        env_info = {
    ...
    def run(self, test_mode=False):
        ...
        behavior_encoder_rnn = np.zeros((self.args.batch_size_run, self.args.num_encoder_layer, self.args.n_agents,
                                            self.max_vehicle_num, 2 * self.args.behavior_encoder_dim), dtype=np.float32)
